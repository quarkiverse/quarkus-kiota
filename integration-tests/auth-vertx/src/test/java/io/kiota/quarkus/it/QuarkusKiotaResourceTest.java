...
public class QuarkusKiotaResourceTest {
    ...
    public void testHelloEndpointUsingTheKiotaClient() throws Exception {
        ...
        OAuth2WebClient oAuth2WebClient = OAuth2WebClient.create(WebClient.create(vertx), oAuth2Auth)
    ...
    public void testVertxExample() throws Exception {
        ...
        OAuth2WebClient oAuth2WebClient = OAuth2WebClient.create(webClient, oAuth2Auth).withCredentials(oauth2Credentials);
